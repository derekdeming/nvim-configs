return {
 ...
 ██████  █████████████████████ ████ █████ █████ ████ ██████ 
      ...
      sections = {
        ...
        { section = "startup" },
        { pane = 2, padding = 2 },
        -- image/terminal section removed
      },
    },
  ...
  keys = {
    ...
    { "<leader>sg", function() Snacks.picker.grep() end, desc = "[S]earch by [G]rep" },
    {
      ...
      function()
        vim.ui.input(
          { prompt = "Grep in dir: ", default = vim.fn.getcwd(), completion = "dir" },
          function(dir)
            if dir and dir ~= "" then
    ...
    { "<leader>sf", function() Snacks.picker.files() end, desc = "[S]earch [F]iles" },
    {
      ...
      function()
        vim.ui.input(
          { prompt = "Find files in dir: ", default = vim.fn.getcwd(), completion = "dir" },
          function(dir)
            if dir and dir ~= "" then
